...
class EnhancedPyUninstallXPro:
    ...
    def _setup_smart_automation_tab(self): 
        ...
        # Animation label
        self.automation_animation = ttk.Label(progress_frame, text="", font=("Segoe UI", 12))
        ...
        self.automation_tree = ttk.Treeview(results_frame, columns=columns, show="tree headings", height=12)
    
        self.automation_tree.heading("#0", text="", anchor="w")
        self.automation_tree.column("#0", width=0, stretch=False)
    
        automation_column_widths = {"Task": 200, "Status": 100, "Time": 150, "Duration": 100, "Details": 400}
